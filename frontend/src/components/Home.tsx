...
export function Home(): JSX.Element {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!data.nome || !['sim', 'nao'].includes(data.confirmado)) {
      setStatus('Por favor, preencha seu nome e escolha se irá comparecer.')
      return
    }

    try {
      const res = await fetch('http://localhost:5000/api/confirmar', {
        method: 'POST',
  ...
  return (
    <div className="container">
      <header>
        <h1>Chá Fraldas do Lorenzo</h1>
        <p>
          Estamos muito felizes em compartilhar esse momento com você.
          <br />
          Por favor, confirme sua presença até o dia 10/01/2026.
        </p>
      </header>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="opcoes">
          ...
          <div>
            <input type="radio" id="confirmado-sim" name="confirmado" value="sim" required />
